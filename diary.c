...

{
...

    {
        ...
        printf("\n\n\t\t\t\t\t\t\t \xDB\xDB\xDB MAIN MENU: \xDB\xDB\xDB\n");

        printf("\n\n\t\t\t\t\xDB\xDB\xDB ADD RECORD\t:-1");

        printf("\n\n\t\t\t\t\xDB\xDB\xDB VIEW RECORD\t:-2");

        printf("\n\n\t\t\t\t\xDB\xDB\xDB EDIT RECORD\t:-3");

        printf("\n\n\t\t\t\t\xDB\xDB\xDB DELETE RECORD:-4");

        printf("\n\n\t\t\t\t\xDB\xDB\xDB EXIT\t:-5");

        printf("\n\n\t\tENTER YOUR LOVELY CHOICE:\n\t\t");
